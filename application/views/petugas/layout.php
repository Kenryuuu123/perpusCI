...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>petugas/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b>RSIDS</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ...
                <p>
                  <?php echo $value->nama;?>
                  <small>Petugas Perpus RSI DS</small>
                </p>
                <?php
              }
              ?>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>petugas/Home">
          <img src="<?php echo base_url(); ?>assets2/img/rsi.png" alt="" srcset="" width="47px">
        </a>
      </center>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i> <span>Master Dokumen</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>petugas/Dokumen/dokumen"><i class="fa fa-book"></i>Data Dokumen</a></li>
              <li><a href="<?php echo base_url(); ?>petugas/Kategori"><i class="fa fa-tags"></i>Data Kategori</a></li>
              <li><a href="<?php echo base_url(); ?>petugas/Penerbit"><i class="fa fa-pencil-square-o"></i>Data Penerbit</a></li>
              <li><a href="<?php echo base_url(); ?>petugas/Instansi"><i class ="fa fa-user-secret"></i>Data instansi</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2025 <a href="https://rsidarussyifa.co.id/rsids/">RS Darus Syifa'</a>.</strong> All rights reserved.
  </footer>
...
$(document).ready(function() {
  ...
  //format dokumen
  function format_dokumen(d) {
    return (
        '<div class="box box-info">' +
        '<div class="box-header with-border"></div>' +
        '<div class="box-body no-padding">' +
        '<table class="table table-striped">' +
        '<tr><td>No Dokumen</td><td>' + d[0] + '</td></tr>' +
        '<tr><td>Deskripsi</td><td>' + d[1] + '</td></tr>' +
        '<tr><td>Judul Dokumen</td><td>' + d[2] + '</td></tr>' +
        '<tr><td>Kategori</td><td>' + d[3] + '</td></tr>' +
        '<tr><td>Penerbit</td><td>' + d[4] + '</td></tr>' +
        '<tr><td>Instansi</td><td>' + d[5] + '</td></tr>' +
        '<tr><td>Tanggal</td><td>' + d[6] + '</td></tr>' +
        '<tr><td>Nama File</td><td>' + d[7] + '</td></tr>' +
        '<tr><td>No Dokumen</td><td>' + d[8] + '</td></tr>' +
        '<tr><td>Keterangan</td><td>' + d[9] + '</td></tr>' +
        '<tr><td>Berkas</td><td><a href="' + d[10] + '">' + d[10] + '</a></td></tr>' +
        '<tr><td>Sifat</td><td>' + d[11] + '</td></tr>' +
        '</table>' +
        '</div>' +
        '</div>'
    );
...
$(document).ready(function () {
    var table = $('#table-dokumen').DataTable({
        dom: 'lfrtip', // Untuk show entries dan search
        columnDefs: [
            {
                targets: "_all",
                defaultContent: "-", // Kolom kosong akan diisi "-"
            },
        ],
    });

    $('#table-dokumen tbody').on('click', 'td.details-control', function () {
        var tr = $(this).closest('tr');
        var row = table.row(tr);
        ...
        if (row.child.isShown()) {
            ...
            row.child(format_dokumen(row.data())).show();
            tr.addClass('shown');
        }
    });
});
