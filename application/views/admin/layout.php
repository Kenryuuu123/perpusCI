          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ...
                <p>
                  <?php echo $value->nama;?>
                  <small>Admin Perpus RSI DS</small>
                </p>
                <?php
              }
              ?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Dokumen/dokumen"><i class="fa fa-book"></i>Data Dokumen</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Kategori"><i class="fa fa-tags"></i>Data Kategori</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Penerbit"><i class="fa fa-pencil-square-o"></i>Data Penerbit</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Instansi"><i class ="fa fa-user-secret"></i>Data instansi</a></li>
          </ul>
        </li>
