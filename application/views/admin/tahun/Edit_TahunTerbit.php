...
<div class="box box-solid box-success">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Penerbit/update" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Tahun Terbit</label>
                  <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Tahun Penerbit</label>
                  <div class="col-sm-4">
  ...
  <div class="box-footer">
    Update Data Tahun Terbit Jurnal, edit form diatas untuk mengubah data Tahun Jurnal. 
  </div><!-- box-footer -->
</div><!-- /.box -->
