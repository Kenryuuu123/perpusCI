            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/rsi.png" width="45px" alt=""></a>
                            <ul class="right hide-on-med-and-down">
                                <li><a href="<?php echo base_url();?>Buku/list_buku">Daftar Buku</a></li>
                                <li><a href="<?php echo base_url();?>Dokumen/list_dokumen">Daftar Dokumen</a></li>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/rsi.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">DARUS SYIFA LEARING SYSTEM</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/per.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    IT &copy; : <a href="" target="_blank">RSi Darus Syifa</a>
                </div>
